...
>
  <section class="flex gap-3 w-full justify-stretch flex-wrap md:flex-nowrap">
    ...
    <div class="flex flex-col gap-2 w-full md:w-1/3 justify-between bg-minecraft-ui-light dark:bg-minecraft-ui-dark pixel-corners">
      <div class="flex flex-col gap-2">
        ...
        <div class="px-2 text-sm pixel-corners p-2 flex bg-white dark:bg-black m-2 divide-x divide-create-blue/20">
  ...
  <section class=" bg-minecraft-ui-light dark:bg-minecraft-ui-dark p-3 pixel-corners">
